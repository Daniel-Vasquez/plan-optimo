...
import type {
  BodyMetric, Food, Note, NutritionLog, Profile, RunningSession, StrengthSession, WaterLog,
} from '../../types/models';
...
export function bodyMetricsCollection(): Collection<BodyMetric> {
  return getDb().collection<BodyMetric>(COLLECTIONS.bodyMetrics);
}
