import{j as w,k,e as $,l as S,h as C,m as M,n as D,o as T}from"./ViewTransitions.astro_astro_type_script_index_0_lang.DxLj3x3s.js";import"https://cdn.jsdelivr.net/npm/chart.js@4.4.4/dist/chart.umd.min.js";function L(e){if(!e)return null;const[r,s]=e.split(":").map(Number);return isNaN(r)||isNaN(s)?null:r*60+s}function x(e){const r=new Date(e+"T00:00:00");return new Intl.DateTimeFormat("es-MX",{month:"short",day:"numeric"}).format(r)}function R(e){return`
    ...
    `;document.getElementById("progress-content").innerHTML=`
      ...
      ${v}
    `,setTimeout(()=>{f("pace-chart",b,p,"#47c2ff",!0,!1,void 0),f("dist-chart",o,a,"#47c2ff",!1,!1,void 0),f("water-chart",m,g,"#47c2ff",!1,!0,2)},100)}document.addEventListener("DOMContentLoaded",A);
