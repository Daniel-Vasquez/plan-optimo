...
> **Estado:** en migración (Tandas 1 a 3 de 8 completadas). La app ya es multiusuario: renderiza en servidor, guarda en MongoDB y exige sesión. Los módulos de fitness siguen leyendo de `localStorage` hasta que cada tanda los migre. El plan completo está en [`planificacion.md`](./planificacion.md).
